...
public class LinearInterpolationTest {
	...
	public LinearInterpolationTest(List<Point2d> points, OneVariableFunction expectedFunction) {
		this.points = points;
    ...
    public void testLinearInterpolator(){
    	OneVariableFunction interpolation = LinearInterpolation.interpolate(points);
        for(int i = 0; i<7; i++) {
    ...
    private void printResult(OneVariableFunction function) {
     ...
     public static List<Point2d> createPoints() {
